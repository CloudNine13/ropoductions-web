...
async function runVerification() {
  ...
  try {
    ...
    await deletePatronOverrideGuarded(db, overridePatronId);
    ...
    const soleChanges = await deletePatronOverrideGuarded(db, soleAdminId);
    ...
    await deletePatronOverrideGuarded(db, soleAdminId);
