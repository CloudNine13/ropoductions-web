...
export function PatreonPaywallCard({
  ...
  return (
    <div
      className={`w-full max-w-2xl mx-auto rounded-2xl border border-border/80 bg-card/95 backdrop-blur-md p-6 sm:p-8 shadow-2xl shadow-black/80 space-y-8 ${className}`}
    >
      <div className="flex flex-col items-center text-center space-y-3">
        <div className="flex h-14 w-14 items-center justify-center rounded-full bg-accent/15 border border-accent/40 shadow-[0_0_24px_rgba(251,191,36,0.25)]">
